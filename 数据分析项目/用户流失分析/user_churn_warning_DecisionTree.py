...
conn = pymysql.connect(host='localhost', port=3306, user='root', password='123456', db='text', charset='utf8')
cursor = conn.cursor()

sql_info = ''' select *  from  text.user_churn_warning'''
...
clf = tree.DecisionTreeClassifier(max_depth=3)          # 深度为3层
